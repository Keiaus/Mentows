...
const About = () => {
    return (
        <div>
            <title>About | Mentows</title>
            <p style={{ textAlign: 'center', fontSize: '50px', fontFamily: 'bold' }}>About</p>
            <p style={{ textAlign: 'center', fontSize: '20px', fontFamily: 'sans-serif bold', maxWidth: '500px', margin: 'auto' }}>Mentows is an internet hosting service for Astronomers.
