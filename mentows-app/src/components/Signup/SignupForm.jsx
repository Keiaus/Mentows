                        ...
                        <div id='next-container' style={{ height: '630px', width: '500px', backgroundColor: 'whitesmoke', margin: 'auto', borderRadius: '3%', marginTop: '50px' }}>
                            <div id='container' style={{ textAlign: 'center', marginTop: '50px' }}>
                                ...
                                <div>
                                    ...
                                    <button type='submit' id='yes' style={{ height: '40px', width: '150px', fontSize: '20px', marginTop: '60px', borderRadius: '3%', cursor: 'pointer' }} onClick={handleYesClicked}>Yes</button>
                                    <br />
                                    <button type='submit' id='no' style={{ height: '40px', width: '150px', fontSize: '20px', marginTop: '10px', borderRadius: '3%', cursor: 'pointer' }} onClick={handleNoClicked}>No</button>
